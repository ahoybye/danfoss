...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <flowActions>
        ...
        <description>Flow Trigger - This flow trigger restart the Case Milestones, that means when Spam Case is moved back to regular Queue or user, then milestones will be initiated back.</description>
