...
ISBLANK( BMCServiceDesk__FKRequestDefinition__c )</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND(BMCServiceDesk__Type__c = &apos;Service Request&apos;, BMCServiceDesk__Category_ID__c = &apos;Power Solutions Specific IT Services&apos;, BMCServiceDesk__state__c, NOT( BMCServiceDesk__inactive__c ), IF(BMCServiceDesk__AllTaskCloseController__c, ISCHANGED(BMCServiceDesk__AllTaskCloseController__c), false) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
