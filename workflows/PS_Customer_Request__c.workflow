...
Confirmed_Date__c &gt;  Customer_Requested_Date__c,
OR( 
RecordType.DeveloperName = &quot;Drawing&quot;, 
RecordType.DeveloperName = &quot;New_Material_Number&quot;, 
RecordType.DeveloperName = &quot;New_Product_Feature&quot;, 
RecordType.DeveloperName = &quot;PPAP&quot;,
RecordType.DeveloperName = &quot;Special_Tests_Certificates&quot;, 
RecordType.DeveloperName = &quot;System_Model&quot; 
) 
)</formula>
...
NOT(ISPICKVAL(Status__c, &quot;Waiting for Ownership&quot;))
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(ISPICKVAL(Status__c, &quot;In Progress&quot;), 
ISCHANGED( Customer_Requested_Date__c ))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
