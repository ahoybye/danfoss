...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Rejected_Contract_Email</fullName>
        <description>Rejected Contract Email</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
        ...
        <senderType>CurrentUser</senderType>
        <template>Contracts/Contract_Rejected</template>
    </alerts>
    <fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Set_Record_Type_to_Locked</fullName>
        <field>RecordTypeId</field>
        <lookupValue>Approval_Locked</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>Set Record Type to Locked</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Set_Record_Type_to_Standard</fullName>
        <field>RecordTypeId</field>
        <lookupValue>Standard</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>Set Record Type to Standard</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Set_Rejection_Email_Sent_Flag</fullName>
        <field>RejectedFlag__c</field>
        <literalValue>1</literalValue>
        <name>Set Rejection Email Sent Flag</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        <fullName>Send Rejected Email</fullName>
        <actions>
            <name>Rejected_Contract_Email</name>
            <type>Alert</type>
        </actions>
        <actions>
            <name>Set_Rejection_Email_Sent_Flag</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>Contract__c.RejectionEmailSent__c</field>
            <operation>equals</operation>
            <value>False</value>
        </criteriaItems>
        <description>notify creator and all approvers</description>
    ...
    <rules>
        <fullName>Set Record Type to Locked</fullName>
        <actions>
            <name>Set_Record_Type_to_Locked</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            <field>Contract__c.Submit_for_Approval__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <criteriaItems>
            <field>Contract__c.Sales_Stage__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>Contract__c.RecordTypeId</field>
            <operation>notEqual</operation>
            <value>Approval Locked</value>
        </criteriaItems>
        <description>sets the record type to Locked</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Set Record Type to Standard</fullName>
        <actions>
            <name>Set_Record_Type_to_Standard</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>Contract__c.RecordTypeId</field>
            <operation>notEqual</operation>
            <value>Standard,Legacy Contract</value>
        </criteriaItems>
        <description>sets the record type to Standard</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
